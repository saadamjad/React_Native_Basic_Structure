(window["webpackJsonpreact-able-pro"] = window["webpackJsonpreact-able-pro"] || []).push([[4],{

/***/ "./src/App/layout/AdminLayout/Breadcrumb/index.js":
/*!********************************************************!*\
  !*** ./src/App/layout/AdminLayout/Breadcrumb/index.js ***!
  \********************************************************/
...
/* harmony import */ var _menu_items__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../menu-items */ "./src/menu-items.js");
...
var _jsxFileName = "/Users/macbook/covid19/pxweb/src/App/layout/AdminLayout/Breadcrumb/index.js";
...
class Breadcrumb extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(...args) {
    ...
    this.UNSAFE_componentWillReceiveProps = () => {
      _menu_items__WEBPACK_IMPORTED_MODULE_3__["default"].items.map((item, index) => {
  ...
  render() {
    ...
    if (this.state.item && this.state.item.type === 'item') {
      ...
      item = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
        className: "breadcrumb-item",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 64
      ...
      if (this.state.item.breadcrumbs !== true) {
    ...
    document.title = title + ' | Revolutionize Patient Experience';
...
/* harmony default export */ __webpack_exports__["default"] = ({
  items: [{
    ...
    // },
    {
      ...
      //     title: 'Actions',
      //     type: 'item',
      //     url:'/dashboard/Intervene/actions'
      // },
      ] // children: [
      //     {
      //         id: 'vertical',
